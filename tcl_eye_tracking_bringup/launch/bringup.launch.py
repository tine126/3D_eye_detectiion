...
def generate_launch_description():
    # ========== FastDDS 配置：启用共享内存零拷贝 ==========
    # HbmMsg1080P 使用 6MB 固定数组，启用 data_sharing 实现零拷贝传输
    ...
    # 启用零拷贝 loaned messages
    set_loaned_msg_env = SetEnvironmentVariable(
